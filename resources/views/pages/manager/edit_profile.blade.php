...
@section('main')
    ...
    <main class="w-full flex justify-center items-start bg-gray-200">
        <div class="w-3/6 min-h-screen bg-white py-14 px-24 flex flex-col items-center">
            ...
            <form action="{{route('profile.merge')}}" method="post" enctype="multipart/form-data" class="w-full flex flex-col items-center">
                @csrf
                ...
                <fieldset class="flex flex-col w-5/6 mt-4">
                    <label for="password" class="font-bold">Confirmar Senha</label>
