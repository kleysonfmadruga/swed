        ...
        <div class="w-3/6 min-h-screen bg-white py-14 px-24 flex flex-col items-center">
            ...
            <form action="#" class="w-full flex flex-col items-center">
                ...
                <fieldset class="flex flex-col w-5/6 mt-4">
                    ...
                    <input type="number" value="{{$establishment->cnpj}}" pattern="\d{2}\.?\d{3}\.?\d{3}/?\d{4}-?\d{2}" name="cnpj" id="cnpj" class="h-8 px-2 rounded"/>
                </fieldset>
                <fieldset class="flex flex-col w-5/6 mt-4">
                    <label for="opening_hours" class="font-bold">Horário de funcionamento</label>
                    <input type="text" value="{{$establishment->opening_hours}}" name="opening_hours" id="opening_hours" class="h-8 px-2 rounded"/>
                </fieldset>
                <fieldset class="flex flex-col w-5/6 mt-4">
                    <label for="phone" class="font-bold">Telefone de contato</label>
                    <input type="text" value="{{''}}" name="phone" id="phone" class="h-8 px-2 rounded"/>
                </fieldset>
                <fieldset class="flex flex-col w-5/6 mt-4">
                    <label for="neighborhood" class="font-bold">Bairro</label>
                    <input type="text" value="{{''}}" name="neighborhood" id="neighborhood" class="h-8 px-2 rounded"/>
                </fieldset>
                <fieldset class="flex flex-col w-5/6 mt-4">
                    <label for="street" class="font-bold">Rua</label>
                    <input type="text" value="{{''}}" name="street" id="street" class="h-8 px-2 rounded"/>
                </fieldset>
                <fieldset class="flex flex-col w-5/6 mt-4">
                    <label for="cep" class="font-bold">CEP</label>
                    <input type="text" value="{{''}}" name="cep" id="cep" class="h-8 px-2 rounded"/>
                </fieldset>
                <fieldset class="flex flex-col w-5/6 mt-4">
